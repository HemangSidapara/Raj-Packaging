                              ...
                              return Column(
                                children: [
                                  ...
                                  TextFieldWidget(
                                    ...
                                    title:
                                        "${S.current.orderQuantity} (${createOrderBloc.orderTypeIndex == 2
                                            ? S.current.boxes
                                            : createOrderBloc.orderTypeIndex == 1
                                            ? S.current.sheets
                                            : S.current.rolls})",
                                  ...
                                  TextFieldWidget(
                                    ...
                                    title:
                                        "${createOrderBloc.orderTypeIndex == 2 ? S.current.productionSheetQuantity : S.current.productionQuantity} (${createOrderBloc.orderTypeIndex == 2
                                            ? S.current.boxes
                                            : createOrderBloc.orderTypeIndex == 1
                                            ? S.current.sheets
                                            : S.current.rolls})",
    ...
    await showModalBottomSheet(
      ...
      builder: (context) {
        ...
        return StatefulBuilder(
          builder: (context, specificationTypeState) {
            return GestureDetector(
              onTap: Utils.unfocus,
              child: DecoratedBox(
                decoration: BoxDecoration(
